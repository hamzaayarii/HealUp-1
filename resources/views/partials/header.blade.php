        ...
        <div class="px-2 pt-2 pb-3 space-y-1 bg-white border-t border-gray-200">
            @auth
                ...
                <a href="{{ route('profile.show') }}"
                    class="mobile-nav-link block px-3 py-2 text-gray-700 hover:bg-gray-50">
                    Profile
                </a>
                <!-- Logout Form -->
                <form method="POST" action="{{ route('logout') }}" class="mt-2">
                    @csrf
                    <button type="submit"
                        class="mobile-nav-link block w-full text-left px-3 py-2 text-gray-700 hover:bg-gray-50">
                        Sign out
                    </button>
                </form>
            @else
