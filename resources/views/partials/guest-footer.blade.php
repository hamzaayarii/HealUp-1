...
<footer class="guest-footer bg-gray-50 border-t border-gray-200" role="contentinfo">
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">

        <!-- Guest Footer Grid -->
        <div class="guest-footer-grid grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8">
            ...
            <div class="brand-section col-span-1 sm:col-span-2 lg:col-span-2">
                ...
                <div class="cta-section">
                    <h4 class="text-sm font-semibold text-gray-900 mb-3">Ready to get started?</h4>
                    <div class="flex flex-col sm:flex-row gap-3">
                        ...
                        <a href="{{ route('login') }}"
                            class="inline-flex items-center justify-center px-4 py-2 border border-gray-300 text-gray-700 font-medium rounded-md hover:bg-gray-50 transition-colors">
                            Sign In
                        </a>
                    </div>
                </div>
            ...
            <div class="product-links">
                ...
                <ul class="space-y-2">
                    ...
                    <li>
                        <a href="#security" class="text-gray-600 hover:text-gray-900 transition-colors">
                            Security
                        </a>
                    </li>
                    <li>
                        <a href="#integrations" class="text-gray-600 hover:text-gray-900 transition-colors">
                            Integrations
                        </a>
                    </li>
                </ul>
            ...
            <div class="company-links">
                ...
                <ul class="space-y-2">
                    ...
                    <li>
                        <a href="#careers" class="text-gray-600 hover:text-gray-900 transition-colors">
                            Careers
                        </a>
                    </li>
                    <li>
        ...
        <div class="newsletter-section mt-8 pt-8 border-t border-gray-200">
            <div class="max-w-md">
        ...
        <div class="footer-bottom mt-8 pt-8 border-t border-gray-200">
            <div class="flex flex-col md:flex-row justify-between items-center space-y-4 md:space-y-0">
                ...
                <!-- Legal Links -->
                <div class="legal-links flex items-center space-x-6">
                    <a href="#privacy" class="text-gray-500 hover:text-gray-700 text-sm transition-colors">
                        Privacy Policy
                    </a>
                    <a href="#terms" class="text-gray-500 hover:text-gray-700 text-sm transition-colors">
                        Terms of Service
                    </a>
                    <a href="#cookies" class="text-gray-500 hover:text-gray-700 text-sm transition-colors">
                        Cookie Policy
                    </a>
                </div>
