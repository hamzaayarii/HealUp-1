...
<div class="container mx-auto py-8">
    <div class="flex justify-between items-center mb-6">
        <h1 class="text-3xl font-bold text-green-700">✏️ Modifier Ingrédient</h1>
        ...
        <form action="{{ route('ingredients.update', $ingredient) }}" method="POST" enctype="multipart/form-data">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div>
                    ...
                    <input type="text" name="nom" id="nom" value="{{ old('nom', $ingredient->nom) }}" 
                ...
                <div>
                    ...
                    <select name="categorie" id="categorie" 
                        ...
                        <option value="laitiers" {{ old('categorie', $ingredient->categorie) == 'laitiers' ? 'selected' : '' }}>🥛 Produits laitiers</option>
                    </select>
                </div>
            ...
            <div class="mt-6">
                ...
                <textarea name="description" id="description" rows="3" 
                          class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-green-500 focus:ring-green-500">{{ old('description', $ingredient->description) }}</textarea>
            </div>
            ...
            <div class="mt-6">
                ...
                <input type="text" name="allergenes" id="allergenes" 
                       value="{{ old('allergenes', $ingredient->allergenes) }}" 
            ...
            <div class="mt-6">
                ...
                @if($ingredient->image)
                    <div class="mt-2 mb-4">
                        <img src="{{ asset('storage/ingredients/' . $ingredient->image) }}" alt="{{ $ingredient->nom }}" class="w-32 h-32 object-cover rounded-lg">
